...
import 'package:calagem_brasil_pro/app/modules/analysis/view_analysis/functions/animation_utils.dart';
import 'package:calagem_brasil_pro/app/modules/analysis/view_analysis/widgets/two_animated_builders.dart';
...
class _AnimatedCardDeckState extends State<AnimatedCardDeck> with TickerProviderStateMixin {
  ...
  @override
  void initState() {
    _shiftController = AnimationController(vsync: this, duration: Duration(milliseconds: 500));
    _moveController = AnimationController(vsync: this, duration: Duration(milliseconds: 1000));
    curvedAnimation = CurvedAnimation(parent: _moveController!, curve: Curves.easeInOut);
    super.initState();
            ...
            return Stack(
              children: List.generate(
                ...
                (index) {
                  ...
                  return Builder(
                    builder: (context) {
                      var yRotate = getAnimValue(start: 0.5, end: 0.6, animation: _moveController!);
                      var xRotate = getAnimValue(start: -0.8, end: -0.1, animation: _moveController!);
                      ...
                      var _3DEffectCardAnimDetails = ATMCardAnimationDetails(
                        move: isOut
                            ? getAnimValue(animation: _moveController!, start: (numberOfCards + 1) - 1.0, end: moveEnd)
                            : getAnimValue(
                                start: moveStart,
                                end: moveEnd,
                      ...
                      for (int i = widget.cardsDetailsList.length - 1; i > 0; i--) {
